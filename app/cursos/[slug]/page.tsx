...
import PythonCoursePlayer from "@/components/PythonCoursePlayer";
import ExcelCoursePlayer from "@/components/ExcelCoursePlayer";
import PowerBiCoursePlayer from "@/components/PowerBiCoursePlayer";
...
export default async function CourseDetailPage({ params }: { params: Promise<{ slug: string }> }) {
	...
	if (slug === "power-bi-intermedio" || slug === "power-bi-avanzado") redirect("/cursos/power-bi-basico");
	if (slug === "excel-intermedio" || slug === "excel-avanzado") redirect("/cursos/excel-basico");
	if (slug === "python-intermedio" || slug === "python-avanzado") redirect("/cursos/python-basico");
