      ...
      <main className="bg-blue-50/50">
        <section className="mx-auto max-w-5xl px-6 py-20">
          ...
          <div className="mt-10 max-w-4xl space-y-10 text-base leading-8 text-muted">
            <article><h2 className="font-display text-2xl font-bold text-ink">¿Qué es DataM?</h2><p className="mt-3"><strong className="font-display text-ink">DataM es una plataforma de educación digital (EdTech) y una empresa de tecnología aplicada al aprendizaje en línea.</strong> Lidera la creación de cursos, la gestión de aulas virtuales y la formación profesional mediante herramientas digitales e inteligencia artificial. Nace para acercar el conocimiento a las personas y convertir la tecnología en una herramienta para crear oportunidades, ofreciendo un espacio donde estudiantes, jóvenes y emprendedores puedan desarrollar capacidades, descubrir nuevas posibilidades y transformar sus ideas en soluciones reales. Creemos que aprender tecnología no consiste únicamente en conocer herramientas, sino en adquirir la capacidad de pensar, crear, resolver problemas y adaptarse a un mundo en constante evolución.</p></article>
