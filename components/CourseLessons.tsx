                          ...
                          <div id={`lesson-content-${course.slug}-${moduleIndex}-${lessonIndex}`} className="border-t border-line bg-base px-3 py-5 sm:px-5">
                            <div className="grid gap-4 lg:grid-cols-[1.25fr_0.75fr]">
                              ...
                              <aside className="data-cell h-fit p-4 sm:p-5 lg:sticky lg:top-24">
                                ...
                                <p className="mt-2 text-base leading-6 text-muted sm:text-sm sm:leading-normal">Descarga una guía breve para practicar los conceptos de esta clase a tu ritmo.</p>
                                <button onClick={() => downloadMaterial(lesson.title, lesson.topics)} aria-label={`Descargar material de práctica de ${lesson.title}`} className="mt-4 flex min-h-11 w-full items-center justify-center gap-2 rounded-cell border border-blue-300 px-3 py-3 text-base font-medium text-blue-700 transition-colors hover:bg-blue-50 sm:py-2 sm:text-sm"><Download className="h-4 w-4" /> Descargar material</button>
                              </aside>
                            </div>
