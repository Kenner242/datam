...
const assessments: Record<string, CourseAssessment> = {
  "excel-basico": {
    projectTitle: "Dashboard profesional de ventas por zona",
    projectInstructions: "Entrega un libro con base tabular limpia, fórmulas con referencias absolutas y relativas, SI/Y/O, CONTAR.SI y SUMAR.SI, una búsqueda exacta para cruzar catálogo, controles de validación, una tabla dinámica con segmentadores, formato condicional, KPIs y una conclusión basada en datos. Documenta los pasos de actualización con Power Query y describe una macro segura que automatizaría una tarea repetitiva. Incluye comprobaciones del total y del periodo reportado.",
    acceptedFormats: "Comparte un enlace a un archivo .xlsx o .xlsm en OneDrive, Google Drive o GitHub. Incluye una nota con la fuente, reglas de cálculo, validaciones y conclusión. No habilites macros de archivos desconocidos.",
    questions: [
      ...
      { prompt: "Al copiar `=B2*$B$1` una fila abajo, ¿qué sucede?", options: ["B2 cambia a B3 y `$B$1` permanece fijo", "Ambas referencias permanecen fijas", "Ambas referencias cambian a la fila 2", "La fórmula se vuelve texto"], correctOption: 0 },
      { prompt: "¿Qué devuelve `=CONTAR.SI(A2:A8;\">100\")`?", options: ["Cuántos valores superan 100", "La suma de valores mayores que 100", "El promedio del rango", "La fila del valor máximo"], correctOption: 0 },
      { prompt: "¿Qué limitación tiene BUSCARV?", options: ["La clave debe estar en la primera columna del rango", "No devuelve texto", "Solo acepta fechas", "No permite coincidencia exacta"], correctOption: 0 },
      { prompt: "¿Qué ventaja tiene INDICE+COINCIDIR?", options: ["Puede buscar en una columna y devolver datos de otra a la izquierda", "Elimina automáticamente duplicados", "Crea una tabla dinámica", "Evita validar el resultado"], correctOption: 0 },
      { prompt: "¿Qué es importante recordar sobre una lista de validación?", options: ["Pegar datos puede evadir controles y requiere revisión", "Impide cualquier error de negocio", "Corrige los datos históricos automáticamente", "Reemplaza la limpieza de datos"], correctOption: 0 },
      { prompt: "¿Qué ventaja tiene convertir una base en Tabla con Ctrl+T?", options: ["Filtros y expansión al agregar registros", "Elimina duplicados sin revisión", "Genera automáticamente una macro", "Reemplaza los encabezados"], correctOption: 0 },
      { prompt: "¿Qué modifica el formato condicional?", options: ["La apariencia según reglas, no el valor almacenado", "El valor de la fórmula", "El tipo de dato siempre", "El orden de las filas"], correctOption: 0 },
      { prompt: "¿Qué área de una tabla dinámica suele contener las métricas agregadas?", options: ["Valores", "Título", "Barra de estado", "Nombre del archivo"], correctOption: 0 },
      { prompt: "¿Qué gráfico comunica mejor la evolución mensual de ventas?", options: ["Líneas", "Circular 3D", "Anillo", "Mapa sin ejes"], correctOption: 0 },
      { prompt: "¿Qué hace Power Query en un flujo de análisis?", options: ["Registra pasos repetibles para importar y transformar datos", "Solo dibuja gráficos", "Activa macros automáticamente", "Reemplaza todos los indicadores"], correctOption: 0 },
      { prompt: "¿Qué control aplicar antes de habilitar una macro recibida?", options: ["Verificar el origen y las acciones del archivo", "Cambiar el color de la hoja", "Ocultar la extensión", "Ordenar las pestañas"], correctOption: 0 },
      ...sharedQuestions,
    ],
  },
  "excel-intermedio": {
  ...
  "power-bi-basico": {
    projectTitle: "Dashboard profesional con modelo gobernado",
    projectInstructions: "Entrega un proyecto Power BI con modelo estrella, dimensión calendario marcada, medidas DAX para total, promedio, CALCULATE, un iterador y una variación temporal. Diseña páginas con jerarquía visual, segmentadores, drill-through y una conclusión basada en evidencia. Implementa y prueba un rol RLS, documenta optimizaciones, workspace, permisos, refresh programado y gateway si la fuente lo requiere. Incluye supuestos y límites del análisis.",
    acceptedFormats: "Comparte un enlace a repositorio o almacenamiento con el archivo .pbix, un README del modelo y las medidas, evidencia de prueba de RLS y capturas del informe publicado o del plan de publicación. No compartas credenciales ni datos sensibles.",
    questions: [
      ...
      { prompt: "¿Qué diferencia una medida de una columna calculada?", options: ["La medida se evalúa según el contexto; la columna se calcula por fila", "La medida siempre contiene texto", "La columna cambia con cada clic del visual", "No tienen ninguna diferencia"], correctOption: 0 },
      { prompt: "¿Qué debe cumplir la clave del lado uno de una relación 1:N?", options: ["Tener valores únicos", "Tener solo blancos", "Ser texto obligatoriamente", "Estar ordenada de mayor a menor"], correctOption: 0 },
      { prompt: "¿Cuándo es preferible SUMX a SUM?", options: ["Cuando hay que calcular una expresión por fila antes de agregar", "Siempre que la columna ya contiene el total", "Para contar valores distintos", "Para crear una relación"], correctOption: 0 },
      { prompt: "¿Qué hace CALCULATE?", options: ["Evalúa una expresión con un contexto de filtro modificado", "Cambia el tipo de una columna", "Importa una tabla", "Dibuja una tarjeta"], correctOption: 0 },
      { prompt: "¿Qué aporta una tabla calendario continua?", options: ["Permite comparaciones temporales consistentes", "Elimina la necesidad de relaciones", "Crea automáticamente permisos", "Reduce toda cardinalidad a uno"], correctOption: 0 },
      { prompt: "¿Qué mide Performance Analyzer?", options: ["Tiempos de visuales y consultas", "El número de usuarios con licencia", "La seguridad RLS", "Los colores de la página"], correctOption: 0 },
      { prompt: "¿Qué controla RLS?", options: ["Qué filas puede consultar cada rol", "Qué visuales se pueden colorear", "El tamaño del archivo PBIX", "La frecuencia del refresh"], correctOption: 0 },
      { prompt: "¿Cuándo puede necesitarse un gateway?", options: ["Cuando Service debe acceder a una fuente local", "Para ejecutar SUM", "Para crear un bookmark", "Para ordenar una tabla"], correctOption: 0 },
      { prompt: "¿Por qué mostrar el periodo y la definición junto a un KPI?", options: ["Da contexto para interpretar el valor", "Hace que el modelo no necesite fechas", "Oculta diferencias", "Sustituye la validación"], correctOption: 0 },
      { prompt: "¿Qué ventaja tiene un modelo estrella bien diseñado?", options: ["Facilita filtros, medidas y mantenimiento", "Evita limpiar datos", "Elimina todas las dimensiones", "Garantiza que no existan errores de negocio"], correctOption: 0 },
      { prompt: "¿Qué buena práctica aplica mínimo privilegio?", options: ["Asignar solo los permisos necesarios para la tarea", "Dar administración a todos", "Compartir credenciales", "Publicar el modelo sin roles"], correctOption: 0 },
      ...sharedQuestions,
    ],
  },
  "power-bi-intermedio": {
  ...
  "python-basico": {
    projectTitle: "Gestor de ventas Python distribuible",
    projectInstructions: "Entrega un paquete Python con `pyproject.toml` y documentación breve. Modela registros con POO y herencia, valida entradas con excepciones específicas, procesa ventas con un generador, añade un decorador con `functools.wraps`, persiste datos JSON en un archivo usando `with`, coordina al menos dos corrutinas con `asyncio` y cubre las reglas principales con pruebas `unittest`. Incluye instrucciones para instalar o ejecutar el proyecto y evidencia de pruebas aprobadas.",
    acceptedFormats: "Comparte un repositorio GitHub que incluya el código, pyproject.toml, README, archivos de prueba y una evidencia de ejecución. No incluyas credenciales ni datos personales.",
    questions: [
      ...
      { prompt: "¿Qué ventaja ofrece una comprensión con filtro frente a agregar cada elemento manualmente?", options: ["Garantiza que la lista quede ordenada", "Expresa transformación y selección de forma directa", "Evita validar los datos", "Convierte siempre los elementos a texto"], correctOption: 1 },
      { prompt: "¿Qué excepción conviene capturar al convertir texto no numérico con int()?", options: ["KeyError", "StopIteration", "ValueError", "ImportError"], correctOption: 2 },
      { prompt: "¿Qué garantiza `with open(...)` al salir de su bloque?", options: ["La conversión automática a JSON", "El cierre del archivo", "La eliminación del archivo", "La ejecución concurrente"], correctOption: 1 },
      { prompt: "¿Qué diferencia a `json.dumps` de `json.loads`?", options: ["dumps serializa a texto y loads interpreta texto JSON", "dumps lee archivos y loads los cierra", "Ambas ordenan diccionarios", "loads solo funciona con números"], correctOption: 0 },
      { prompt: "¿Qué palabra clave pausa una función generadora y entrega un valor?", options: ["break", "await", "yield", "super"], correctOption: 2 },
      { prompt: "¿Para qué se usa `super().__init__(...)` en una subclase?", options: ["Crear un módulo nuevo", "Ejecutar todas las pruebas", "Convertir el objeto en JSON", "Reutilizar la inicialización de la clase base"], correctOption: 3 },
      { prompt: "¿Qué aporta `functools.wraps` dentro de un decorador?", options: ["Ejecuta la función en paralelo", "Convierte la función en una clase", "Captura todas las excepciones", "Conserva metadatos de la función envuelta"], correctOption: 3 },
      { prompt: "¿Qué suele comprobar un método `test_...` de unittest?", options: ["El diseño visual del programa", "Una regla observable mediante una aserción", "La velocidad de internet", "El nombre de cada variable local"], correctOption: 1 },
      { prompt: "¿Por qué se usa `await asyncio.gather(...)` para varias tareas de I/O?", options: ["Ejecuta automáticamente CPU en varios procesos", "Evita que las tareas fallen", "Coordina esperas concurrentes de varias corrutinas", "Convierte funciones normales en generadores"], correctOption: 2 },
      { prompt: "¿Qué archivo declara metadatos de un proyecto Python moderno?", options: ["index.html", "pyproject.toml", "requirements.docx", "package.css"], correctOption: 1 },
      { prompt: "¿Qué hace que un decorador sea más mantenible?", options: ["Ocultar todos los errores", "Cambiar variables globales sin documentarlo", "Duplicar la función original", "Envolver el comportamiento y preservar el contrato de la función"], correctOption: 3 },
      ...sharedQuestions,
    ],
  },
  "python-intermedio": {
