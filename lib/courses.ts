...
const baseCourses: Course[] = [
	...
	// Python
	common("python-basico", "B10", "Python Básico", "Básico", "5 semanas", "Lógica de programación y bases del lenguaje Python desde cero.", images.python, "Aprenderás variables, decisiones, ciclos, funciones y estructuras de datos para construir soluciones pequeñas y explicarlas con claridad.", "Te dará las bases para automatizar tareas simples, analizar información y continuar hacia el análisis de datos.", [
		module("Introducción a Python", [lesson("¿Qué es Python?", ["Sintaxis clara", "Usos profesionales", "print y comentarios"]), lesson("Variables y tipos de datos", ["Números y texto", "Booleanos", "Entrada y salida de datos"])]),
		module("Operadores y decisiones", [lesson("Operadores y lógica", ["Aritmética", "Comparaciones", "and, or y not"]), lesson("Condicionales", ["if", "elif y else", "Indentación"])]),
		module("Bucles y automatización", [lesson("while y for", ["Repetición", "range", "Bucles seguros"]), lesson("Automatiza una tarea", ["Acumuladores", "Patrones repetitivos", "Caso aplicado"])]),
		module("Funciones reutilizables", [lesson("Definir funciones", ["def", "Parámetros", "Llamadas"]), lesson("Return y errores", ["Valores de retorno", "Reutilización", "Manejo básico de errores"])]),
		module("Estructuras de datos", [lesson("Listas", ["Índices", "Recorridos", "len, sum, max y min"]), lesson("Diccionarios", ["Claves y valores", "Recorridos", "Modelar información"])]),
		module("Proyecto aplicado", [lesson("Analizador de ventas", ["Métricas", "Funciones", "Reporte con f-strings"]), lesson("Presenta tu solución", ["Documentación", "Buenas prácticas", "Comunicación técnica"])])
	]),
