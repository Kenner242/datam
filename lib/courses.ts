...
const baseCourses: Course[] = [
	// Excel
	common("excel-basico", "B1", "Excel Básico", "Básico", "4 semanas", "Primeros pasos para organizar y calcular información en Excel.", images.excel, "Aprenderás la interfaz, fórmulas esenciales y el orden de datos para empezar a trabajar con hojas de cálculo con confianza.", "Te permitirá llevar registros simples, calcular totales y presentar información ordenada en cualquier trabajo.", [module("Primeros pasos en Excel", [lesson("Interfaz y navegación", ["Celdas, filas y columnas", "Tipos de datos", "Guardar y compartir archivos"], "https://youtu.be/hoCmAgr-oLM"), lesson("Fórmulas básicas", ["Suma, promedio y conteo", "Referencias relativas", "Orden de operaciones"]) ]), module("Organizar y presentar datos", [lesson("Tablas y formato", ["Formato como tabla", "Filtros simples", "Formato condicional básico"]), lesson("Funciones esenciales", ["Función SI", "CONTAR.SI", "BUSCARV básico"])])]),
